...
/// @param p_Remote If set to true, this is essentially the same as calling the old
/// CoreSdk_Initialize
/// @return SDKReturnCode_Success if successful,
/// SDKReturnCode_FunctionCalledAtWrongTime if the function was not intended to be called at this
/// time.
...
CoreSdk_WasDllBuiltInDebugConfiguration(bool* p_WasBuiltInDebugConfiguration);
...
/// @param p_LoopbackOnly if true it looks for hosts only locally, if false it looks for hosts
...
/// time.
CORESDK_API SDKReturnCode
CoreSdk_GetNumberOfAvailableHostsFound(uint32_t* p_NumberOfAvailableHostsFound);
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_FunctionCalledAtWrongTime if the function was not intended to be called at this
/// time SDKReturnCode_ArgumentSizeMismatch if p_NumberOfHostsThatFitInArray does not match the
/// number of available hosts found in the network, SDKReturnCode_InvalidArgument if the provided
/// p_AvailableHostsFound is a null pointer, SDKReturnCode_InternalError if the number of available
/// hosts found is higher than the defined MAX_NUMBER_OF_HOSTS,
/// SDKReturnCode_UnsupportedStringSizeEncountered if the name of a host is higher than the defined
/// MAX_NUM_CHARS_IN_HOST_NAME, SDKReturnCode_Error if copying the string representing the host name
/// was not successful, SDKReturnCode_NullPointer if invalid host data was found.
CORESDK_API SDKReturnCode
CoreSdk_GetAvailableHostsFound(ManusHost* p_AvailableHostsFound,
...
/// SDKReturnCode_FunctionCalledAtWrongTime if the function was not intended to be called at this
/// time, SDKReturnCode_NoCoordinateSystemSet if the user tried to connect without first setting up
/// the coordinate system settings.
...
/// @param p_UseWorldCoordinates if true all data will be defined with respect to a world coordinate
/// system, if false all data will be defined with respect to a local one,
/// @return SDKReturnCode_Success if successful,
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available.
CORESDK_API SDKReturnCode
CoreSdk_InitializeCoordinateSystemWithVUH(CoordinateSystemVUH p_CoordinateSystem,
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available.
CORESDK_API SDKReturnCode
CoreSdk_InitializeCoordinateSystemWithDirection(CoordinateSystemDirection p_CoordinateSystem,
                                                bool p_UseWorldCoordinates);
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available.
CORESDK_API SDKReturnCode
CoreSdk_RegisterCallbackForOnConnect(ConnectedToCoreCallback_t p_ConnectedCallback);

/// @brief Register the callback function that is called when manus core gets disconnected from the
/// sdk.
/// @param p_DisconnectedCallback
/// @return SDKReturnCode_Success if successful,
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available.
CORESDK_API SDKReturnCode
CoreSdk_RegisterCallbackForOnDisconnect(DisconnectedFromCoreCallback_t p_DisconnectedCallback);
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available.
CORESDK_API SDKReturnCode
CoreSdk_RegisterCallbackForSkeletonStream(SkeletonStreamCallback_t p_SkeletonStreamCallback);
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available.
CORESDK_API SDKReturnCode
CoreSdk_RegisterCallbackForTrackerStream(TrackerStreamCallback_t p_TrackerStreamCallback);
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available.
CORESDK_API SDKReturnCode
CoreSdk_RegisterCallbackForSystemStream(SystemStreamCallback_t p_SystemStreamCallback);
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available.
CORESDK_API SDKReturnCode
CoreSdk_RegisterCallbackForGestureStream(GestureStreamCallback_t p_GestureStreamCallback);
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_InternalError if the number of available gloves found is higher than the defined
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_ArgumentSizeMismatch if p_NumberOfIdsThatFitInArray does not match with the number
/// of available gloves found, SDKReturnCode_InvalidArgument if p_NumberOfIdsThatFitInArray is zero
/// or is higher than the defined MAX_NUMBER_OF_GLOVES.
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_DataNotAvailable if no glove with the provided p_GloveId was found in the
/// landscape.
/// @deprecated Get this through the Landscape instead
[[deprecated("Get this through the Landscape instead")]]
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_DataNotAvailable if no dongle with the provided p_DongleId was found in the
/// landscape.
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_InternalError if the number of dongles found is higher than the defined
/// MAX_NUMBER_OF_DONGLES.
/// @deprecated Get this through the Landscape instead
[[deprecated("Get this through the Landscape instead")]]
...
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_ArgumentSizeMismatch if p_NumberOfIdsThatFitInArray does not match with the number
/// of dongles found, SDKReturnCode_InvalidArgument if p_NumberOfIdsThatFitInArray is zero or higher
/// than the defined MAX_NUMBER_OF_HAPTICS_DONGLES.
/// @deprecated Get this through the Landscape instead
[[deprecated("Get this through the Landscape instead")]]
...
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_ArgumentSizeMismatch if p_NumberOfIdsThatFitInArray does not match with the number
/// of haptic dongles found, SDKReturnCode_InvalidArgument if p_NumberOfIdsThatFitInArray is zero or
/// higher than the defined MAX_NUMBER_OF_HAPTICS_DONGLES.
/// @deprecated Get this through the Landscape instead
[[deprecated("Get this through the Landscape instead")]]
...
/// Note that this is reliant on the landscape, and the first second after connecting the client to
/// the core it will not yet have landscape data, so the number of users wil be 0. Since there will
/// always be a default users, just wait until the count is above 0 and then proceed.
/// @param p_NumberOfAvailableUsers
/// @return SDKReturnCode_Success if successful,
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_InternalError if the number of available users found is higher than the defined
/// MAX_NUMBER_OF_USERS.
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_InvalidArgument if p_NumberOfIdsThatFitInArray is null or higher than the defined
/// MAX_NUMBER_OF_USERS, or if p_IdsOfAvailableUsers is a null array.
/// SDKReturnCode_ArgumentSizeMismatch if p_NumberOfIdsThatFitInArray does not match with number of
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_ArgumentSizeMismatch if p_TrackerIndex is higher than the total number of trackers
/// received from the tracker stream.
CORESDK_API SDKReturnCode CoreSdk_GetTrackerData(uint32_t p_TrackerIndex,
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_InternalError if the number of trackers found is higher than the defined
/// MAX_NUMBER_OF_TRACKERS.
CORESDK_API SDKReturnCode
CoreSdk_GetNumberOfAvailableTrackers(uint32_t* p_NumberOfAvailableTrackers);
...
/// MAX_NUMBER_OF_TRACKERS, or if p_IdsOfAvailableTrackers is a null array.
/// SDKReturnCode_ArgumentSizeMismatch if p_NumberOfIdsThatFitInArray does not match with the number
/// of available trackers found.
...
/// MAX_NUMBER_OF_TRACKERS.
CORESDK_API SDKReturnCode
CoreSdk_GetNumberOfAvailableTrackersForUserId(uint32_t* p_NumberOfAvailableTrackers,
                                              uint32_t p_UserId);
...
/// of available trackers found.
CORESDK_API SDKReturnCode
CoreSdk_GetIdsOfAvailableTrackersForUserId(TrackerId* p_IdsOfAvailableTrackers,
                                           uint32_t p_UserId,
                                           uint32_t p_NumberOfIdsThatFitInArray);
...
/// MAX_NUMBER_OF_TRACKERS.
CORESDK_API SDKReturnCode
CoreSdk_GetNumberOfAvailableTrackersForUserIndex(uint32_t* p_NumberOfAvailableTrackers,
...
/// of available trackers found.
CORESDK_API SDKReturnCode
CoreSdk_GetIdsOfAvailableTrackersForUserIndex(TrackerId* p_IdsOfAvailableTrackers,
                                              uint32_t p_UserIndex,
                                              uint32_t p_NumberOfIdsThatFitInArray);
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_DataNotAvailable if no tracker with the given p_TrackerId was found in the
/// landscape.
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_DataNotAvailable if no tracker with the given p_TrackerId and the given
/// p_TrackerType was found in the landscape.
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_StubNullPointer if the stub has been reset but someone is trying to use it anyway.
/// This usually happens after a shutdown of the SDK, SDKReturnCode_NullPointer if the provided
/// p_TrackerData is a null pointer, SDKReturnCode_InvalidArgument if p_NumberOfTrackers is null or
/// higher than the defined MAX_NUMBER_OF_TRACKERS.
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_StubNullPointer if the stub has been reset but someone is trying to use it anyway.
/// This usually happens after a shutdown of the SDK, SDKReturnCode_NotConnected if there is no
/// connection to core.
CORESDK_API SDKReturnCode CoreSdk_SetTrackerOffset(uint32_t p_UserId,
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_ArgumentSizeMismatch if p_ArraySize is higher than the total number of gestures in
/// the landscape stream.
CORESDK_API SDKReturnCode
CoreSdk_GetGestureLandscapeData(GestureLandscapeData* p_LandscapeDataArray, uint32_t p_ArraySize);

/// @brief The start data index allows you to get more data if there are more than
/// MAX_GESTURE_DATA_CHUNK_SIZE gestures.
...
/// the landscape stream.
CORESDK_API SDKReturnCode
CoreSdk_GetGestureStreamData(uint32_t p_GestureStreamDataIndex,
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core
CORESDK_API SDKReturnCode CoreSdk_GloveCalibrationStart(GloveCalibrationArgs p_CalibrationArgs,
                                                        bool* p_Result);
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core
CORESDK_API SDKReturnCode CoreSdk_GloveCalibrationStop(GloveCalibrationArgs p_CalibrationArgs,
                                                       bool* p_Result);
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core
CORESDK_API SDKReturnCode CoreSdk_GloveCalibrationFinish(GloveCalibrationArgs p_CalibrationArgs,
                                                         bool* p_Result);
...
/// SDKReturnCode_NotConnected if there is no connection to core
CORESDK_API SDKReturnCode
CoreSdk_GloveCalibrationGetNumberOfSteps(GloveCalibrationArgs p_CalibrationArgs,
...
/// SDKReturnCode_NotConnected if there is no connection to core
CORESDK_API SDKReturnCode
CoreSdk_GloveCalibrationGetStepData(GloveCalibrationStepArgs p_CalibrationStepArgs,
...
/// SDKReturnCode_NotConnected if there is no connection to core
CORESDK_API SDKReturnCode
CoreSdk_GloveCalibrationStartStep(GloveCalibrationStepArgs p_CalibrationStepArgs, bool* p_Result);

CORESDK_API SDKReturnCode CoreSdk_GetGloveCalibrationSize(uint32_t p_GloveId, uint32_t* p_Size);

CORESDK_API SDKReturnCode CoreSdk_GetGloveCalibration(unsigned char* p_CalibrationBytes,
                                                      uint32_t p_BytesLength);

CORESDK_API SDKReturnCode CoreSdk_SetGloveCalibration(uint32_t p_GloveId,
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_ArgumentSizeMismatch if p_SkeletonIndex is higher than the total number of
/// skeletons received from the skeleton stream.
...
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_ArgumentSizeMismatch if p_SkeletonIndex is higher than the total number of
/// skeletons received from the skeleton stream or if the provided p_NodeCount is different from the
/// node count of that skeleton.
...
/// SDKReturnCode_ArgumentSizeMismatch if p_SkeletonIndex is higher than the total number of
/// skeletons received from the skeleton stream.
CORESDK_API SDKReturnCode CoreSdk_GetRawSkeletonInfo(uint32_t p_SkeletonIndex,
...
/// skeletons received from the skeleton stream or if the provided p_NodeCount is different from the
/// node count of that skeleton.
CORESDK_API SDKReturnCode CoreSdk_GetRawSkeletonData(uint32_t p_SkeletonIndex,
                                                     SkeletonNode* p_Nodes,
                                                     uint32_t p_NodeCount);

/// @brief Identifies if the glove associated to the skeleton with given id and side is a haptic
/// one.
/// @param p_SkeletonId
/// @param p_HandType
/// @param p_IsHaptics
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_DataNotAvailable if the requested glove is not found or if the skeleton does not
/// have any user associated to it, SDKReturnCode_InvalidArgument if the provided p_HandType is
...
/// @brief Create a new SkeletonSetup with the given information and returns the index on which it
/// is saved.
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_ArgumentSizeMismatch if the maximum number of temporary skeletons per session has
/// been reached, when this happens the user can either load or clear a temporary skeleton in order
/// to create a new skeleton setup.
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any skeleton
/// setup.
...
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any skeleton
/// setup, SDKReturnCode_NullPointer if the skeleton setup was not correctly saved, thus the new
/// skeleton setup is a null pointer.
CORESDK_API SDKReturnCode CoreSdk_OverwriteSkeletonSetup(uint32_t p_SkeletonSetupIndex,
                                                         SkeletonSetupInfo p_SkeletonSetup);

/// @brief Overwrite a chain in a SkeletonSetup, the chain to be overwritten is idenfified by
/// p_Chain.id.
...
/// @brief Overwrite a node in a SkeletonSetup, the node to be overwritten is identified by
/// p_Node.id.
/// @param p_SkeletonSetupIndex The SkeletonSetup's index, not to be confused by the Chain's ID.
...
/// setup.
CORESDK_API SDKReturnCode
CoreSdk_GetSkeletonSetupArraySizes(uint32_t p_SkeletonSetupIndex,
...
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_StubNullPointer if the stub has been reset but someone is trying to use it anyway.
/// This usually happens after a shutdown of the SDK, SDKReturnCode_InvalidID if the provided
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// /// SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any
/// skeleton setup.
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_NullPointer if the provided p_SDK (used to store the setup chains) is a null
/// pointer, it should be initialized to an array with size equal to the chains count,
/// SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any skeleton
/// setup.
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_NullPointer if the provided p_ChainSetupArray (used to store the setup chains) is
/// a null pointer, it should be initialized to an array with size equal to the chains count,
/// SDKReturnCode_ArgumentSizeMismatch if the provided p_ArraySize is not equal to the chains count,
/// SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any skeleton
/// setup.
CORESDK_API SDKReturnCode CoreSdk_GetSkeletonSetupChainsArray(uint32_t p_SkeletonSetupIndex,
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_NullPointer if the provided p_SDK (used to store the setup nodes) is a null
/// pointer, it should be initialized to an array with size equal to the nodes count,
/// SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any skeleton
/// setup.
...
/// SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any skeleton
/// setup.
CORESDK_API SDKReturnCode CoreSdk_GetSkeletonSetupNodesArray(uint32_t p_SkeletonSetupIndex,
...
/// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_NullPointer if the provided p_SDK (used to store the setup colliders) is a null
/// pointer, it should be initialized to an array with size equal to the colliders count,
/// SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any skeleton
/// setup.
/// @deprecated
[[deprecated]]
...
CORESDK_API SDKReturnCode CoreSdk_GetRawSkeletonNodeCount(uint32_t p_GloveId,
                                                          uint32_t& p_NodeCount);

/// @brief Get the information for nodes of the raw skeleton with given id
/// The size of the given array p_NodeInfo must match the node count retrieved from
...
/// @brief Get the information for nodes of the raw skeleton with given id
/// The size of the given array p_NodeInfo and p_NodeCount must match the node count retrieved from
/// CoreSdk_GetRawSkeletonNodeCount.
/// @param p_GloveId
...
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_InvalidID if the provided glove id does not match any skeleton in core,
/// SDKReturnCode_ArgumentSizeMismatch if p_ArraySize does not match node count retrieved from
/// CoreSdk_GetRawSkeletonNodeCount.
CORESDK_API SDKReturnCode CoreSdk_GetRawSkeletonNodeInfoArray(uint32_t p_GloveId,
...
/// SkeletonStreamCallback. Loading a skeleton into core for retargetting removes it from the
/// temporary skeletons array, thus causing the p_SkeletonSetupIndex to no longer be valid after
/// this call.
...
/// @brief Unload a skeleton with a certain ID from Manus Core, so data will no longer be generated
/// for it.
...
/// @brief Save a SkeletonSetup at a given index and sessionId into Manus Core for use in the Dev
/// Tools. p_IsSkeletonModified is intended to be used mainly by the Dev Tools, it is set to true
/// after saving any modification to the skeleton, this triggers the OnSyStemCallback which is used
/// in the SDK to be notified about a change to its temporary skeletons.
/// @param p_SkeletonSetupIndex
/// @param p_SessionId
...
/// @brief Send a temporary skeleton to Core to compress it (convert it into an array of bytes) and
/// then get the compressed data back in the SDK, the skeleton compressed data are stored
/// internally. It returns the length of the bytes array for correct memory allocation. This
/// function must be called before CoreSdk_GetCompressedTemporarySkeletonData.
/// @param p_SkeletonSetupIndex
/// @param p_SessionId
/// @param p_TemporarySkeletonLengthInBytes
/// @return
CORESDK_API SDKReturnCode
CoreSdk_CompressTemporarySkeletonAndGetSize(uint32_t p_SkeletonSetupIndex,
                                            uint32_t p_SessionId,
                                            uint32_t* p_TemporarySkeletonLengthInBytes);

/// @brief Get the compressed temporary skeleton data which are stored internally when calling
/// function CoreSdk_CompressTemporarySkeletonAndGetSize. The size of p_TemporarySkeletonData must
/// match with p_TemporarySkeletonLengthInBytes.
...
/// p_SkeletonSetupIndex does not correspond to any skeleton setup.
CORESDK_API SDKReturnCode
CoreSdk_GetCompressedTemporarySkeletonData(unsigned char* p_TemporarySkeletonData,
                                           uint32_t p_TemporarySkeletonLengthInBytes);
...
/// SDKReturnCode_NotConnected if there is no connection to core,
/// SDKReturnCode_StubNullPointer if the stub has been reset but someone is trying to use it anyway.
/// This usually happens after a shutdown of the SDK,
CORESDK_API SDKReturnCode CoreSdk_GetTemporarySkeleton(uint32_t p_SkeletonSetupIndex,
                                                       uint32_t p_SessionId);

/// @brief Send the compressed data (an array of bytes) retrieved from a file to Core to be
/// decompressed and converted back into a temporary skeleton. The received temporary skeleton is
/// saved internally with the given index and to the given session id. The size of
/// p_TemporarySkeletonData must match with p_TemporarySkeletonLengthInBytes.
/// @param p_SkeletonSetupIndex
/// @param p_SessionId
/// @param p_TemporarySkeletonData
/// @param p_TemporarySkeletonLengthInBytes
...
/// This usually happens after a shutdown of the SDK,
CORESDK_API SDKReturnCode
CoreSdk_GetTemporarySkeletonFromCompressedData(uint32_t p_SkeletonSetupIndex,
                                               uint32_t p_SessionId,
