...
///@brief All these initializers take a preallocated instance of their related structure and set
///default values.
...
/// @param p_Val
CORESDK_API void TemporarySkeletonCountForAllSessions_Init(
    TemporarySkeletonCountForAllSessions* p_Val);
